...
int main()
{
	...
	printf(".\n");
	ringBuffer0to1_RISC.push(A,6);		// передаем 5 слов из A в кольцевой буффер
	printf("head=%d tail=%d.\n",ringBufferData0to1.head,ringBufferData0to1.tail);
	printf("..\n");
	ringBuffer0to1_RISC.push(A+6,6);	// передаем 5 слов из A в кольцевой буффер
	printf("head=%d tail=%d.\n",ringBufferData0to1.head,ringBufferData0to1.tail);
	printf("...\n");
...
//	printf("....\n");
	...
	//
	//ringBuffer0to1_RISC.push(A,10);		// передаем 4 слова из A в кольцевой буффер
