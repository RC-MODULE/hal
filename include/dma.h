...
typedef int(*DmaCallback2)();
	 ...
	 *	\restr 
	 *  <p>src адрес должен быть четным в противном случае ПДП зависнет
	 ...
	 *	\restr 
	 *	<p>src0 адрес должен быть четным в противном случае ПДП зависнет
	 ...
	 *	<p>intSize0 должен быть четным в противном случае ПДП скопирует на 1 меньше (ближайший четный) 
	 *	<p>intSize1 должен быть четным в противном случае ПДП скопирует на 1 меньше (ближайший четный) 
	 */
