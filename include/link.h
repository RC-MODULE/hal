...
///У процессора nm6407 у каждого ядра есть по три линка(в сумме с двух ядер всего 6). На плате mc12101 наружу выходит 4 линка, LINK0 и LINK1 
///процессорной системы NMPU0 (Выводы X5 и X6), и LINK0 и LINK1 процессорной системы NMPU1 (Выводы X7 и X8 соответсвенно).
///
